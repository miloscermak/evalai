...
(function () {
  ...
  const I18N = {
    ...
    cs: {
      ...
      'a2.opt.translate':  'Překlady a komunikace v cizím jazyce',
      ...
      'a3.title': 'Jak hluboko jdeš?',
      'a3.subtitle': 'Označ všechno, co o tobě platí.',
      ...
      'a3.opt.custom_assistant': 'Krmím AI vlastními dokumenty a daty (projekty, znalostní báze, vlastní GPT)',
      ...
      'a6.title': 'Necháš AI zpracovat celý úkol samostatně a pak jen zkontroluješ výsledek?',
      'a6.opt.never':  'Ne — vedu ji krok za krokem',
      'a6.opt.small':  'U drobností ano',
      'a6.opt.verify': 'U věcí, které si umím zkontrolovat',
      'a6.opt.long':   'I u věcí, které bych sám/sama dělal/a hodiny',

      'a4.title': 'Platíš za některou AI službu?',
      'a4.opt.no':       'Ne',
      'a4.opt.employer': 'Ne, ale platí mi ji zaměstnavatel',
      ...
      'a5.opt.copilot':      'Microsoft 365 Copilot (ve Wordu, Outlooku, Teams)',
      'a5.opt.perplexity':   'Perplexity',
      'a5.opt.notebooklm':   'NotebookLM',
      'a5.opt.coding_agent': 'Coding agenti (Claude Code, Cursor, GitHub Copilot)',
      'a5.opt.image':        'MidJourney / DALL-E / Sora / Veo',
      'a5.opt.audio':        'ElevenLabs / Suno',
      'a5.opt.other':        'Jiný chatbot (Grok, Vibe, čínské modely…)',
      'a5.opt.none':       'Žádný',

      // B — postoj
      'b1.title': 'Díky AI bude moje práce zajímavější a lepší.',
    ...
    en: {
      ...
      'a2.title': 'What do you use AI for?',
      ...
      'a2.opt.translate':  'Translation and communicating in another language',
      ...
      'a3.opt.custom_assistant': 'I feed AI my own documents and data (projects, knowledge bases, custom GPTs)',
      ...
      'a6.title': 'Do you let AI handle a whole task on its own and just check the result?',
      'a6.opt.never':  'No — I guide it step by step',
      'a6.opt.small':  'For small things, yes',
      'a6.opt.verify': 'For things I can verify myself',
      'a6.opt.long':   'Even for things that would take me hours',

      'a4.title': 'Do you pay for any AI service?',
      'a4.opt.no':       'No',
      'a4.opt.employer': 'No, but my employer pays for one',
      ...
      'a5.opt.claude':     'Claude',
      'a5.opt.gemini':     'Gemini',
      'a5.opt.copilot':      'Microsoft 365 Copilot (in Word, Outlook, Teams)',
      'a5.opt.perplexity':   'Perplexity',
      'a5.opt.notebooklm':   'NotebookLM',
      'a5.opt.coding_agent': 'Coding agents (Claude Code, Cursor, GitHub Copilot)',
      'a5.opt.image':        'MidJourney / DALL-E / Sora / Veo',
      'a5.opt.audio':        'ElevenLabs / Suno',
      'a5.opt.other':        'Another chatbot (Grok, Vibe, Chinese models…)',
      'a5.opt.none':       'None',

      // B — attitude
      'b1.title': 'Thanks to AI, my work will get more interesting and better.',
